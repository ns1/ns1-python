...
@pytest.mark.parametrize('name, username, email, url', [('test-user',
    'test-username', 'test-email@ns1.io', 'account/users')])
...
@pytest.mark.parametrize('username, name, ip_whitelist, permissions, url',
...
def test_rest_user_update(user_config, username, name, ip_whitelist,
    ...
    z = ns1.rest.user.User(user_config)
    z._make_request = mock.MagicMock()
    z.update(username, name=name, ip_whitelist=ip_whitelist, permissions=permissions)
...
@pytest.mark.parametrize('username, url', [('test-username',
    'account/users/test-username')])
