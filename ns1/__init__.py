...
class NS1:
    ...
    def createReservation(self, scopegroup_id, address_id, mac, dhcp_options, callback=None, errback=None):
        import ns1.ipam
    ...
    def createScope(self, scopegroup_id, address_id, dhcp_options, callback=None, errback=None):
        import ns1.ipam
